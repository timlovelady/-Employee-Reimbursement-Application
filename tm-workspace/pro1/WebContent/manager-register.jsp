...
<div class="container my-5">
    <h1 class="h3 mb-5 fw-normal text-center">Manager Registration</h1>
    <form action="ManagerRegister" method="post">
    <div class="col-8 m-auto">
    <div class="form-floating my-2">
      <input type="text" class="form-control shadow-lg" id="un" name="manager_name">
      <label for="floatingInput">Manager Name</label>
    </div>
    <div class="form-floating my-2">
      <input type="password" class="form-control shadow-lg" id="pw" name="manager_password">
